...
class SupabaseClient {
    ...
    constructor(supabaseUrl, supabaseKey, options) {
        var _a, _b, _c;
        this.supabaseUrl = 'https://tjancutopbwohgmugxbf.supabase.co';
        this.supabaseKey = process.env.eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRqYW5jdXRvcGJ3b2hnbXVneGJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA2ODQ3MjksImV4cCI6MjA2NjI2MDcyOX0.MjurjC_UVWPN7KVGi3f8aQV915g_Q2mNZ0t0KpUXhhA;
        if (!supabaseUrl)
